...
<div id="mySidenav" class="sidenav">
  ...
  <a href="http://localhost/p.php">Mobile category</a>
...
<div id="product-grid">
	...
	?> 
			...
			<div class="product-title" style="font-size:18px;font-family:Comic Sans MS, cursive, sans-serif;font-weight:bold;"><?php echo $rows["NAME"]; ?></div>
			<br><b>Price: </b><?php echo $rows["PRICE"]; ?><br>
			<b>Seller: </b><?php echo $rows["SELLER"]; ?><br>
            <b>RAM: </b><?php echo $rows["RAM"]; ?><br>
			<b>ROM: </b><?php echo $rows["ROM"]; ?><br>
