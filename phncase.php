...
$sql = "SELECT IMAGE,PRICE,MODEL_TYPE,COLOR,MODEL_SUBSTANCE,OFFERS from phncase"; 
...
<th align="left"><font color="white">Phonecase category</th>
</tr>
</table>
<div id="product-grid">
	...
	?> 
			...
			<b>Model type: </b><?php echo $rows["MODEL_TYPE"]; ?><br>
            <b>Model substance: </b><?php echo $rows["MODEL_SUBSTANCE"]; ?><br>
